...
【説明文】
（120〜180文字。商品の魅力（デザインの特徴・素材感・着こなし方・季節感など）が伝わる文章のみを書くこと。見出し・実寸・注意書きは書かない。1文ごとに改行を入れて読みやすくする。箇条書きにはしない。絵文字は✨・😊・🍀の中からのみ選び、1〜2文につき1個程度、控えめに使う。🌸は実寸の表記で使用しているため文章中では使わない。使いすぎてごちゃごちゃした印象にならないようにする）
